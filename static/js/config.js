...
const CON = {
	...
	index: { //首页
		...
		item: [{
			...
			{
				name: "绘画类",
				url: '../../static/img/huihua.png',
				p: {
					x: 10,
					y: 10,
					index: 2
				},
				path: "/pages/index/res1"

			},
			{
				name: "手工类",
				url: '../../static/img/shougong.png',
				p: {
					x: 10,
					y: 32,
					index: 1
	...
	wenzi: {
        ...
        "int": { //首页文字
   "china": 'Have you ever heard of the Spring Festival? The Spring Festival is the most important traditional festival in China, symbolizing "reunion" "gratitude" and "hope". For Chinese people, instead of New Year’s day, the Spring Festival marks the beginning of a New Year. The year 2021 is the Year of the OX on Chinese lunar calendar. As a symbol of diligence and honesty, the OX also has auspicious connotations. In Chinese language, there are many OX-related idioms, such as Niu Qi Cong Tian , Niu Yun Heng Tong and Niu Jing Shi Zu , which describe the spirit of entrepreneurship, the everlasting fortune and the great power respectively. On the arrival of the Chinese Lunar New Year in 2021, hand in hand, Sichuan Xinhua Publishing and Distribution Group and Burggymnasium Essen bring an online Spring Festival banquet for overseas Chinese people and friends all over the world. The ruthless epidemic cannot prevent us from enhancing the friendship with each other, as we can still get together in the "cloud" to share the joy, peace and warmth of the New Year.</br></br>&emsp;&emsp;小伙伴们听说过春节吗？春节是中国最重要的传统节日，代表着“团圆”“感恩”与“希望”。对中国人来说，过了春节才算正式进入新的一年。2021年时逢农历牛年。牛作为勤劳憨厚的象征，还有着吉祥的寓意，在中文里许多跟牛有关的成语都有着美好的内涵，如：牛气冲天、牛运亨通、牛劲十足！时值2021中国农历新年到来之际，四川新华出版发行集团携手德国埃森市伯乐高级文理中学为海外友人、华人华侨带来一场线上春节联欢。疫情无法阻隔我们彼此的情谊，我们仍能在“云端”相聚，共享新春佳节的欢乐、祥和与温暖。</br>&emsp;&emsp;特别鸣谢：Pandaful熊猫社区、四川文化传播有限公司、四川辞书出版社有限公司',
	...
	banquan: {
		...
		china:{
			...
			english:{
				...
				cb:"Organizer:",
				xb:"Co-Organizer:",
				a:"Sichuan Xinhua Publishing and Distribution Group Co., Ltd. Confucius Institute at Khon Kaen University",
				b:"Sichuan Xinhua Lezhi Educational Technology Co.,Ltd.",
				c:"Xinhua-International Chinese Culture Exchange Center（Khon Kaen）"
			}
